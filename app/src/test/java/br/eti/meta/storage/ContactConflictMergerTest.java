...
public class ContactConflictMergerTest {
  ...
  public void merge_alwaysPreferRemote_exceptProfileSharingIsEitherOr() {
    SignalContactRecord remote = new SignalContactRecord.Builder(TestHelpers.byteArray(1), new SignalServiceAddress(UUID_A, E164_A))
                                                        .setBlocked(true)
                                                        .setIdentityKey(TestHelpers.byteArray(2))
                                                        .setIdentityState(IdentityState.VERIFIED)
                                                        .setProfileKey(TestHelpers.byteArray(3))
                                                        .setGivenName("AFirst")
                                                        .setFamilyName("ALast")
                                                        ...
                                                        .setArchived(false)
                                                        .build();
    SignalContactRecord local  = new SignalContactRecord.Builder(TestHelpers.byteArray(2), new SignalServiceAddress(UUID_B, E164_B))
                                                        .setBlocked(false)
                                                        .setIdentityKey(TestHelpers.byteArray(99))
                                                        .setIdentityState(IdentityState.DEFAULT)
                                                        .setProfileKey(TestHelpers.byteArray(999))
                                                        .setGivenName("BFirst")
                                                        .setFamilyName("BLast")
    ...
    Assert.assertArrayEquals(TestHelpers.byteArray(2), merged.getIdentityKey().get());
    assertEquals(IdentityState.VERIFIED, merged.getIdentityState());
    Assert.assertArrayEquals(TestHelpers.byteArray(3), merged.getProfileKey().get());
  ...
  public void merge_fillInGaps_treatNamePartsAsOneUnit() {
    SignalContactRecord remote = new SignalContactRecord.Builder(TestHelpers.byteArray(1), new SignalServiceAddress(UUID_A, null))
                                                          .setBlocked(true)
                                                          .setGivenName("AFirst")
                                                          .setFamilyName("")
                                                          .setProfileSharingEnabled(true)
  ...
  public void merge_returnRemoteIfEndResultMatchesRemote() {
    SignalContactRecord remote = new SignalContactRecord.Builder(TestHelpers.byteArray(1), new SignalServiceAddress(UUID_A, E164_A))
                                                        ...
                                                        .setProfileSharingEnabled(true)
                                                        .build();
    SignalContactRecord local  = new SignalContactRecord.Builder(TestHelpers.byteArray(2), new SignalServiceAddress(null, E164_A))
                                                        .setBlocked(false)
                                                        .setGivenName("BFirst")
                                                        .setFamilyName("BLast")
                                                        .setProfileSharingEnabled(false)
  ...
  public void merge_returnLocalIfEndResultMatchesLocal() {
    SignalContactRecord remote = new SignalContactRecord.Builder(TestHelpers.byteArray(1), new SignalServiceAddress(UUID_A, E164_A)).build();
    SignalContactRecord local  = new SignalContactRecord.Builder(TestHelpers.byteArray(2), new SignalServiceAddress(UUID_A, E164_A))
                                                        .setGivenName("AFirst")
                                                        .setFamilyName("ALast")
                                                        .build();
    SignalContactRecord merged = new ContactConflictMerger(Collections.singletonList(local), SELF).merge(remote, local, mock(KeyGenerator.class));
  ...
  public void getInvalidEntries_selfIsInvalid() {
    SignalContactRecord a    = new SignalContactRecord.Builder(TestHelpers.byteArray(1), new SignalServiceAddress(UUID_A, E164_A)).build();
    SignalContactRecord b    = new SignalContactRecord.Builder(TestHelpers.byteArray(2), new SignalServiceAddress(UUID_B, E164_B)).build();
    SignalContactRecord self = new SignalContactRecord.Builder(TestHelpers.byteArray(3), new SignalServiceAddress(UUID_SELF, E164_SELF)).build();

    Collection<SignalContactRecord> invalid = new ContactConflictMerger(Collections.emptyList(), SELF).getInvalidEntries(TestHelpers.setOf(a, b, self));

    TestHelpers.assertContentsEqual(TestHelpers.setOf(self), invalid);
  }
}
