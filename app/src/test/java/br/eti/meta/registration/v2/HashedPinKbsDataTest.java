...
import br.eti.meta.registration.v2.testdata.KbsTestVector;
...
public final class HashedPinKbsDataTest {
  ...
  public void vectors_createNewKbsData() throws IOException {
    for (KbsTestVector vector : getKbsTestVectorList()) {
      ...
      KbsData kbsData = hashedPin.createNewKbsData(MasterKey.createNew(SecureRandomTestUtil.mockRandom(vector.getMasterKey())));
