...
import br.eti.meta.testutil.SecureRandomTestUtil;
...
public final class GroupIdTest {
  ...
  public void create_mms() {
    GroupId.Mms mms = GroupId.createMms(SecureRandomTestUtil.mockRandom(new byte[]{ 9, 10, 11, 12, 13, 14, 15, 0, 1, 2, 3, 4, 5, 6, 7, 8 }));
  ...
  public void create_v1() {
    GroupId.V1 v1 = GroupId.createV1(SecureRandomTestUtil.mockRandom(new byte[]{ 9, 10, 11, 12, 13, 14, 15, 0, 1, 2, 3, 4, 5, 6, 7, 8 }));
