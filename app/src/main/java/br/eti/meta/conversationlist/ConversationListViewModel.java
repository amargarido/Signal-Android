...
import br.eti.meta.database.DatabaseContentProviders;
...
import br.eti.meta.search.SearchRepository;
import br.eti.meta.util.Debouncer;
import br.eti.meta.util.Util;
import br.eti.meta.util.concurrent.SignalExecutors;
import br.eti.meta.util.paging.Invalidator;
