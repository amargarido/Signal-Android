...
public class ContactNameEditActivity extends PassphraseRequiredActionBarActivity {
  ...
  static Intent getIntent(@NonNull Context context, @NonNull Contact.Name name, int contactPosition) {
  ...
  protected void onCreate(Bundle savedInstanceState, boolean ready) {
    ...
    Contact.Name name = getIntent().getParcelableExtra(KEY_NAME);
    if (name == null) {
  ...
  private void initializeViews(@NonNull Contact.Name name) {
