...
import static br.eti.meta.contactshare.ContactShareEditViewModel.*;
...
public class ContactShareEditActivity extends PassphraseRequiredActionBarActivity implements ContactShareEditAdapter.EventListener {
  ...
  @Override
  public void onNameEditClicked(int position, @NonNull Contact.Name name) {
  ...
  protected void onActivityResult(int requestCode, int resultCode, Intent data) {
    ...
    Contact.Name name     = data.getParcelableExtra(ContactNameEditActivity.KEY_NAME);
