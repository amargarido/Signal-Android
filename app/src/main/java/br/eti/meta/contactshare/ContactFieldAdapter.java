...
class ContactFieldAdapter extends RecyclerView.Adapter<ContactFieldAdapter.ContactFieldViewHolder> {
  ...
  void setFields(@NonNull  Context             context,
                 @Nullable Contact.Avatar avatar,
                 @NonNull  List<Contact.Phone>         phoneNumbers,
                 @NonNull  List<Contact.Email>         emails,
                 @NonNull  List<Contact.PostalAddress> postalAddresses)
  {
    fields.clear();
  ...
  static class Field {
    ...
    Field(@NonNull Context context, @NonNull Contact.Phone phoneNumber, @NonNull Locale locale) {
    ...
    Field(@NonNull Context context, @NonNull Contact.Email email) {
    ...
    Field(@NonNull Context context, @NonNull Contact.PostalAddress postalAddress) {
    ...
    Field(@NonNull Contact.Avatar avatar) {
      this.value      = "";
