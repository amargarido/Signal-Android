 ...
 */
package br.eti.meta.mediaoverview;
...
import br.eti.meta.util.livedata.LiveDataPair;
...
import br.eti.meta.database.loaders.GroupedThreadMediaLoader;
...
final class MediaGalleryAllAdapter extends StickyHeaderGridAdapter {
  ...
  MediaGalleryAllAdapter(@NonNull Context context,
                         ...
                         GroupedThreadMediaLoader.GroupedThreadMedia media,
  ...
  public void setMedia(GroupedThreadMediaLoader.GroupedThreadMedia media) {
    this.media = media;
  }
  ...
  public void toggleSelection(@NonNull MediaDatabase.MediaRecord mediaRecord) {
  ...
  void selectAllMedia() {
    ...
    for (int section = 0; section < sectionCount; section++) {
      ...
      for (int item = 0; item < sectionItemCount; item++) {
        MediaDatabase.MediaRecord mediaRecord = media.get(section, item);
