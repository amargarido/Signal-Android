...
public final class MediaOverviewActivity extends PassphraseRequiredActionBarActivity {
  ...
  protected void onCreate(Bundle bundle, boolean ready) {
    ...
    model.setSortOrder(allThreads ? MediaDatabase.Sorting.Largest : MediaDatabase.Sorting.Newest);
  ...
  private void setSorting(@NonNull MediaDatabase.Sorting sorting) {
  ...
  private static @StringRes int sortingToString(@NonNull MediaDatabase.Sorting sorting) {
    switch (sorting) {
  ...
  private void showSortOrderDialog(View v) {
    new AlertDialog.Builder(MediaOverviewActivity.this)
      ...
      .setSingleChoiceItems(R.array.MediaOverviewActivity_Sort_by,
        ...
        (dialog, item) -> {
          setSorting(MediaDatabase.Sorting.values()[item]);
          dialog.dismiss();
        })
      .create()
      .show();
