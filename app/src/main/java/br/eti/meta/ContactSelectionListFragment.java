...
import br.eti.meta.components.RecyclerViewFastScroller;
import br.eti.meta.contacts.ContactChip;
import br.eti.meta.contacts.ContactSelectionListAdapter;
import br.eti.meta.contacts.ContactSelectionListItem;
...
import br.eti.meta.util.UsernameUtil;
import br.eti.meta.util.adapter.FixedViewsAdapter;
import br.eti.meta.util.adapter.RecyclerViewConcatenateAdapterStickyHeader;
                                                ...
                                                implements LoaderManager.LoaderCallbacks<Cursor>
{
  ...
  public @NonNull Loader<Cursor> onCreateLoader(int id, Bundle args) {
    ...
    return new ContactsCursorLoader(activity,
                                    activity.getIntent().getIntExtra(DISPLAY_MODE, ContactsCursorLoader.DisplayMode.FLAG_ALL),
