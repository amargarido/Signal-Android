                                                         ...
                                                         StickerPackPreviewAdapter.EventListener
{
  ...
  private void presentManifest(@NonNull StickerManifest manifest) {
    ...
    StickerManifest.Sticker first = manifest.getStickers().isEmpty() ? null : manifest.getStickers().get(0);
    StickerManifest.Sticker cover = manifest.getCover().or(Optional.fromNullable(first)).orNull();
