...
import br.eti.meta.stickers.StickerKeyboardPageFragment.EventListener;
import br.eti.meta.stickers.StickerKeyboardRepository.PackListResult;
import br.eti.meta.util.ResUtil;
import br.eti.meta.util.ThemeUtil;
import br.eti.meta.util.Throttler;
...
/**
 * A provider to select stickers in the {@link MediaKeyboard}.
 */
