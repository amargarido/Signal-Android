...
import br.eti.meta.components.ConversationTypingView;
import br.eti.meta.components.TooltipPopup;
import br.eti.meta.components.recyclerview.SmoothScrollingLinearLayoutManager;
import br.eti.meta.contactshare.Contact;
import br.eti.meta.contactshare.ContactUtil;
import br.eti.meta.contactshare.SharedContactDetailsActivity;
...
import br.eti.meta.jobs.MultiDeviceViewOnceOpenJob;
import br.eti.meta.linkpreview.LinkPreview;
import br.eti.meta.logging.Log;
import br.eti.meta.longmessage.LongMessageActivity;
import br.eti.meta.mediasend.Media;
import br.eti.meta.messagedetails.MessageDetailsActivity;
...
import br.eti.meta.profiles.UnknownSenderView;
import br.eti.meta.providers.BlobProvider;
import br.eti.meta.reactions.ReactionsBottomSheetDialogFragment;
...
import br.eti.meta.recipients.ui.bottomsheet.RecipientBottomSheetDialogFragment;
import br.eti.meta.revealable.ViewOnceMessageActivity;
import br.eti.meta.revealable.ViewOnceUtil;
import br.eti.meta.sharing.ShareActivity;
import br.eti.meta.sms.MessageSender;
import br.eti.meta.sms.OutgoingTextMessage;
import br.eti.meta.stickers.StickerLocator;
import br.eti.meta.stickers.StickerPackPreviewActivity;
import br.eti.meta.util.CachedInflater;
import br.eti.meta.util.CommunicationActions;
import br.eti.meta.util.FeatureFlags;
import br.eti.meta.util.HtmlUtil;
import br.eti.meta.util.RemoteDeleteUtil;
import br.eti.meta.util.SaveAttachmentTask;
...
import br.eti.meta.util.task.ProgressDialogAsyncTask;
import br.eti.meta.util.views.AdaptiveActionsToolbar;
...
public class ConversationFragment extends Fragment {
  ...
  private class ConversationScrollListener extends OnScrollListener {
    ...
    private void bindScrollHeader(ConversationAdapter.StickyHeaderViewHolder headerViewHolder, int positionId) {
