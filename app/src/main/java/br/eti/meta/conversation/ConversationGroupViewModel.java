...
class ConversationGroupViewModel extends ViewModel {
  ...
  private ConversationGroupViewModel() {
    ...
    LiveData<GroupDatabase.GroupRecord> groupRecord = LiveDataUtil.mapAsync(liveRecipient, this::getGroupRecordForRecipient);
  ...
  private GroupDatabase.GroupRecord getGroupRecordForRecipient(Recipient recipient) {
  ...
  private GroupActiveState mapToGroupActiveState(@Nullable GroupDatabase.GroupRecord record) {
    if (record == null) {
      return null;
    }
