...
import br.eti.meta.video.ByteArrayMediaDataSource;
...
public class BlobProvider {
  ...
  public static final Uri        CONTENT_URI = Uri.parse("content://br.eti.meta/blob");
  public static final String     AUTHORITY   = "br.eti.meta";
