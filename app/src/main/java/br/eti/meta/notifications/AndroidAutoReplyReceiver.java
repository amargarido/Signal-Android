...
public class AndroidAutoReplyReceiver extends BroadcastReceiver {
  ...
  public static final String REPLY_ACTION    = "br.eti.meta.notifications.ANDROID_AUTO_REPLY";
    ...
    if (responseText != null) {
      new AsyncTask<Void, Void, Void>() {
        ...
        protected Void doInBackground(Void... params) {
          ...
          List<MessagingDatabase.MarkedMessageInfo> messageIds = DatabaseFactory.getThreadDatabase(context).setRead(replyThreadId, true);
