...
final class ReactionRecipientsAdapter extends RecyclerView.Adapter<ReactionRecipientsAdapter.ViewHolder> {
  ...
  private List<ReactionsLoader.Reaction> data = Collections.emptyList();

  public void updateData(List<ReactionsLoader.Reaction> newData) {
    data = newData;
  ...
  final class ViewHolder extends RecyclerView.ViewHolder {
    ...
    void bind(@NonNull ReactionsLoader.Reaction reaction) {
