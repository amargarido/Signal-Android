...
public class SmsDeliveryListener extends BroadcastReceiver {
  ...
  public static final String SENT_SMS_ACTION      = "br.eti.meta.SendReceiveService.SENT_SMS_ACTION";
  public static final String DELIVERED_SMS_ACTION = "br.eti.meta.SendReceiveService.DELIVERED_SMS_ACTION";
