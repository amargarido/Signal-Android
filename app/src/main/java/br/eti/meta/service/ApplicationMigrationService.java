...
import br.eti.meta.notifications.NotificationIds;
    ...
    implements SmsMigrator.SmsMigrationProgressListener
{
  ...
  public  static final String MIGRATE_DATABASE  = "br.eti.meta.ApplicationMigration.MIGRATE_DATABSE";
  public  static final String COMPLETED_ACTION  = "br.eti.meta.ApplicationMigrationService.COMPLETED";
  ...
  @Override
  public void progressUpdate(SmsMigrator.ProgressDescription progress) {
  ...
  public static class ImportState {
    ...
    public ImportState(int state, SmsMigrator.ProgressDescription progress) {
      this.state    = state;
