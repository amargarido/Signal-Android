...
import br.eti.meta.mms.ApnUnavailableException;
import br.eti.meta.mms.CompatMmsConnection;
import br.eti.meta.mms.IncomingMediaMessage;
import br.eti.meta.mms.MmsException;
import br.eti.meta.mms.MmsRadioException;
import br.eti.meta.mms.PartParser;
...
public class MmsDownloadJob extends BaseJob {
      ...
      throws MmsException
  {
    ...
    Optional<MessagingDatabase.InsertResult> insertResult = database.insertMessageInbox(message, contentLocation, threadId);
  ...
  public static final class Factory implements Job.Factory<MmsDownloadJob> {
    @Override
    public @NonNull MmsDownloadJob create(@NonNull Job.Parameters parameters, @NonNull Data data) {
