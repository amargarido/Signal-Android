...
import br.eti.meta.events.PartProgressEvent;
...
import br.eti.meta.mms.DecryptableStreamUriLoader;
import br.eti.meta.mms.MediaConstraints;
import br.eti.meta.mms.MediaStream;
import br.eti.meta.mms.MmsException;
import br.eti.meta.service.GenericForegroundService;
import br.eti.meta.service.NotificationController;
...
import br.eti.meta.video.InMemoryTranscoder;
import br.eti.meta.video.VideoSizeException;
import br.eti.meta.video.VideoSourceException;
import br.eti.meta.video.videoconverter.EncodingException;

import java.io.ByteArrayInputStream;
import java.io.IOException;
import java.util.concurrent.TimeUnit;

import br.eti.meta.util.MemoryFileDescriptor;
...
public final class AttachmentCompressionJob extends BaseJob {
      ...
      throws UndeliverableMessageException
  {
    ...
    } catch (VideoSourceException | EncodingException | MemoryFileDescriptor.MemoryFileException e) {
