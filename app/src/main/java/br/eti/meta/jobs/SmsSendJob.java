...
import br.eti.meta.service.SmsDeliveryListener;
...
public class SmsSendJob extends SendJob {
  ...
  private SmsSendJob(@NonNull Parameters parameters, long messageId, int runAttempt) {
    super(parameters);
  ...
  private static Parameters constructParameters(@NonNull Recipient destination) {
