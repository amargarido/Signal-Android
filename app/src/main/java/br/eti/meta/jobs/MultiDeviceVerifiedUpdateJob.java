...
public class MultiDeviceVerifiedUpdateJob extends BaseJob {
  ...
  public MultiDeviceVerifiedUpdateJob(@NonNull RecipientId destination, IdentityKey identityKey, IdentityDatabase.VerifiedStatus verifiedStatus) {
  ...
  private MultiDeviceVerifiedUpdateJob(@NonNull Job.Parameters parameters,
                                       ...
                                       @NonNull IdentityDatabase.VerifiedStatus verifiedStatus,
                                       long timestamp)
  {
    super(parameters);
  ...
  private VerifiedMessage.VerifiedState getVerifiedState(IdentityDatabase.VerifiedStatus status) {
  ...
  public static final class Factory implements Job.Factory<MultiDeviceVerifiedUpdateJob> {
    ...
    public @NonNull MultiDeviceVerifiedUpdateJob create(@NonNull Parameters parameters, @NonNull Data data) {
      try {
        ...
        IdentityDatabase.VerifiedStatus verifiedStatus = IdentityDatabase.VerifiedStatus.forState(data.getInt(KEY_VERIFIED_STATUS));
