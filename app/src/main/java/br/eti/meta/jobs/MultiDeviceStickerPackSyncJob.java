...
public class MultiDeviceStickerPackSyncJob extends BaseJob {
  ...
  protected void onRun() throws Exception {
    ...
    try (StickerDatabase.StickerPackRecordReader reader = new StickerDatabase.StickerPackRecordReader(DatabaseFactory.getStickerDatabase(context).getInstalledStickerPacks())) {
