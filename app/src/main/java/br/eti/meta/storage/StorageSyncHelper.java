...
public final class StorageSyncHelper {
  ...
  public static @NonNull Optional<LocalWriteResult> buildStorageUpdatesForLocal(long currentManifestVersion,
                                                                                ...
                                                                                @NonNull List<RecipientDatabase.RecipientSettings> updates,
                                                                                @NonNull List<RecipientDatabase.RecipientSettings> inserts,
                                                                                @NonNull List<RecipientDatabase.RecipientSettings> deletes,
                                                                                ...
                                                                                @NonNull Set<RecipientId> archivedRecipients)
  {
    ...
    for (RecipientDatabase.RecipientSettings insert : inserts) {
    ...
    for (RecipientDatabase.RecipientSettings delete : deletes) {
    ...
    for (RecipientDatabase.RecipientSettings update : updates) {
      StorageId oldId;
      StorageId newId;
