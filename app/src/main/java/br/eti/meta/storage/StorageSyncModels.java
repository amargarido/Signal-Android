...
public final class StorageSyncModels {
  ...
  public static @NonNull SignalStorageRecord localToRemoteRecord(@NonNull RecipientDatabase.RecipientSettings settings, @NonNull Set<RecipientId> archived) {
  ...
  public static @NonNull SignalStorageRecord localToRemoteRecord(@NonNull RecipientDatabase.RecipientSettings settings, @NonNull byte[] rawStorageId, @NonNull Set<RecipientId> archived) {
  ...
  private static @NonNull SignalContactRecord localToRemoteContact(@NonNull RecipientDatabase.RecipientSettings recipient, byte[] rawStorageId, @NonNull Set<RecipientId> archived) {
  ...
  private static @NonNull SignalGroupV1Record localToRemoteGroupV1(@NonNull RecipientDatabase.RecipientSettings recipient, byte[] rawStorageId, @NonNull Set<RecipientId> archived) {
  ...
  private static @NonNull SignalGroupV2Record localToRemoteGroupV2(@NonNull RecipientDatabase.RecipientSettings recipient, byte[] rawStorageId, @NonNull Set<RecipientId> archived) {
    GroupId groupId = recipient.getGroupId();
  ...
  IdentityDatabase.VerifiedStatus remoteToLocalIdentityStatus(@NonNull IdentityState identityState) {
