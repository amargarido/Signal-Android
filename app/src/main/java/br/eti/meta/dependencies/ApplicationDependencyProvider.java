package br.eti.meta.dependencies;
...
import br.eti.meta.messages.IncomingMessageProcessor;
import br.eti.meta.crypto.storage.SignalProtocolStoreImpl;
...
import br.eti.meta.jobmanager.JobMigrator;
import br.eti.meta.jobmanager.impl.JsonDataSerializer;
import br.eti.meta.jobs.FastJobStorage;
import br.eti.meta.jobs.JobManagerFactories;
import br.eti.meta.keyvalue.KeyValueStore;
import br.eti.meta.logging.Log;
import br.eti.meta.megaphone.MegaphoneRepository;
import br.eti.meta.messages.InitialMessageRetriever;
import br.eti.meta.notifications.DefaultMessageNotifier;
import br.eti.meta.notifications.MessageNotifier;
import br.eti.meta.notifications.OptimizedMessageNotifier;
import br.eti.meta.push.SecurityEventListener;
import br.eti.meta.push.SignalServiceNetworkAccess;
import br.eti.meta.recipients.LiveRecipientCache;
import br.eti.meta.messages.IncomingMessageObserver;
import br.eti.meta.util.AlarmSleepTimer;
import br.eti.meta.util.EarlyMessageCache;
import br.eti.meta.util.FeatureFlags;
import br.eti.meta.util.FrameRateTracker;
