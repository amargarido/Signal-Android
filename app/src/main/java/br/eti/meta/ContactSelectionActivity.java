  ...
  protected void onCreate(Bundle icicle, boolean ready) {
    if (!getIntent().hasExtra(ContactSelectionListFragment.DISPLAY_MODE)) {
      int displayMode = TextSecurePreferences.isSmsEnabled(this) ? ContactsCursorLoader.DisplayMode.FLAG_ALL
                                                                 : ContactsCursorLoader.DisplayMode.FLAG_PUSH | ContactsCursorLoader.DisplayMode.FLAG_ACTIVE_GROUPS | ContactsCursorLoader.DisplayMode.FLAG_INACTIVE_GROUPS | ContactsCursorLoader.DisplayMode.FLAG_SELF;
