...
import br.eti.meta.imageeditor.Bounds;
import br.eti.meta.imageeditor.ColorableRenderer;
import br.eti.meta.imageeditor.ImageEditorView;
import br.eti.meta.imageeditor.Renderer;
import br.eti.meta.imageeditor.model.EditorElement;
import br.eti.meta.imageeditor.model.EditorModel;
import br.eti.meta.imageeditor.renderers.FaceBlurRenderer;
import br.eti.meta.imageeditor.renderers.MultiLineTextRenderer;
import br.eti.meta.keyvalue.SignalStore;
import br.eti.meta.logging.Log;
import br.eti.meta.mediasend.MediaSendPageFragment;
import br.eti.meta.mms.MediaConstraints;
import br.eti.meta.mms.PushMediaConstraints;
import br.eti.meta.permissions.Permissions;
import br.eti.meta.providers.BlobProvider;
import br.eti.meta.scribbles.widget.VerticalSlideColorPicker;
import br.eti.meta.util.MediaUtil;
import br.eti.meta.util.ParcelUtil;
