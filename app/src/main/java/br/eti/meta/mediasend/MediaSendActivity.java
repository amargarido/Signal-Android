...
import br.eti.meta.TransportOptions;
...
import br.eti.meta.components.emoji.EmojiEditText;
import br.eti.meta.components.emoji.EmojiKeyboardProvider;
import br.eti.meta.components.emoji.EmojiToggle;
import br.eti.meta.components.emoji.MediaKeyboard;
import br.eti.meta.contactshare.SimpleTextWatcher;
import br.eti.meta.imageeditor.model.EditorModel;
import br.eti.meta.logging.Log;
import br.eti.meta.mediapreview.MediaRailAdapter;
...
import br.eti.meta.scribbles.ImageEditorFragment;
import br.eti.meta.util.CharacterCalculator.CharacterState;
import br.eti.meta.util.Function3;
import br.eti.meta.util.IOFunction;
...
import br.eti.meta.util.views.SimpleProgressDialog;
import br.eti.meta.util.views.Stub;
import br.eti.meta.video.VideoUtil;
