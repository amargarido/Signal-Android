...
import br.eti.meta.jobmanager.JobTracker;
...
import br.eti.meta.lock.RegistrationLockReminders;
import br.eti.meta.lock.v2.PinKeyboardType;
import br.eti.meta.logging.Log;
import br.eti.meta.megaphone.Megaphones;
import br.eti.meta.registration.service.KeyBackupSystemWrongPinException;
...
public final class PinState {
  ...
  /**
   * Should only be called by {@link RegistrationPinV2MigrationJob}.
   */
  @WorkerThread
