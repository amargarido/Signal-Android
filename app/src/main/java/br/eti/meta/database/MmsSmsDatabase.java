...
public class MmsSmsDatabase extends Database {
   ...
   */
  public @Nullable
  RecipientId getGroupAddedBy(long threadId) {
  ...
  public @Nullable
  MessageRecord getMessageFor(long timestamp, RecipientId author) {
  ...
  public boolean incrementReadReceiptCount(MessagingDatabase.SyncMessageId syncMessageId, long timestamp) {
