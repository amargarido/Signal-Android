...
import br.eti.meta.sms.IncomingGroupUpdateMessage;
...
public class SmsDatabase extends MessagingDatabase {
  ...
  public class Reader {
    ...
    public SmsMessageRecord getCurrent() {
      ...
      long                 dateServer           = cursor.getLong(cursor.getColumnIndexOrThrow(DATE_SERVER));
      long                 threadId             = cursor.getLong(cursor.getColumnIndexOrThrow(THREAD_ID));
      ...
      boolean              remoteDelete         = cursor.getInt(cursor.getColumnIndexOrThrow(REMOTE_DELETED)) == 1;
