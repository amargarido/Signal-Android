...
import br.eti.meta.crypto.ClassicDecryptingPartInputStream;
import br.eti.meta.crypto.ModernDecryptingPartInputStream;
import br.eti.meta.crypto.ModernEncryptingPartOutputStream;
import br.eti.meta.database.helpers.SQLCipherOpenHelper;
import br.eti.meta.database.model.databaseprotos.AudioWaveFormData;
import br.eti.meta.logging.Log;
import br.eti.meta.mms.MediaStream;
...
public class AttachmentDatabase extends Database {
  ...
  public @Nullable
  DatabaseAttachment getAttachment(@NonNull AttachmentId attachmentId)
  {
