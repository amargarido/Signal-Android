...
import br.eti.meta.database.model.IncomingSticker;
import br.eti.meta.database.model.StickerPackRecord;
...
public class StickerDatabase extends Database {
  ...
  public @Nullable
  StickerRecord getSticker(@NonNull String packId, int stickerId, boolean isCover) {
  ...
  public @Nullable
  StickerPackRecord getStickerPack(@NonNull String packId) {
