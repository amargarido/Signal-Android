...
import br.eti.meta.crypto.storage.TextSecureIdentityKeyStore;
...
import br.eti.meta.sms.IncomingIdentityDefaultMessage;
import br.eti.meta.sms.IncomingIdentityUpdateMessage;
import br.eti.meta.sms.IncomingIdentityVerifiedMessage;
import br.eti.meta.sms.IncomingTextMessage;
import br.eti.meta.sms.OutgoingIdentityDefaultMessage;
import br.eti.meta.sms.OutgoingIdentityVerifiedMessage;
...
public class IdentityUtil {
  ...
  public static ListenableFuture<Optional<IdentityDatabase.IdentityRecord>> getRemoteIdentityKey(final Context context, final Recipient recipient) {
  ...
  public static void markIdentityUpdate(@NonNull Context context, @NonNull RecipientId recipientId) {
    ...
    Optional<MessagingDatabase.InsertResult>        insertResult     = smsDatabase.insertMessageInbox(individualUpdate);
