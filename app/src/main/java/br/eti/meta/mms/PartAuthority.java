...
import br.eti.meta.providers.PartProvider;
...
public class PartAuthority {
  ...
  private static final String PART_URI_STRING     = "content://br.eti.meta/part";
  private static final String THUMB_URI_STRING    = "content://br.eti.meta/thumb";
  private static final String STICKER_URI_STRING  = "content://br.eti.meta/sticker";
  ...
  static {
    ...
    uriMatcher.addURI("br.eti.meta", "part/*/#", PART_ROW);
    uriMatcher.addURI("br.eti.meta", "thumb/*/#", THUMB_ROW);
    uriMatcher.addURI("br.eti.meta", "sticker/#", STICKER_ROW);
