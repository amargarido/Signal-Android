...
import org.eti.meta.gcm.FcmUtil;
import org.eti.meta.logging.Log;
import org.eti.meta.push.AccountManagerFactory;
import org.eti.meta.registration.PushChallengeRequest;
    ...
    new AsyncTask<Void, Void, VerificationRequestResult>() {
      ...
      VerificationRequestResult doInBackground(Void... voids) {
        try {
          ...
          org.eti.meta.logging.Log.w(TAG, "Error during account registration", e);
