...
import org.eti.meta.jobmanager.JobTracker;
...
import org.eti.meta.lock.RegistrationLockReminders;
import org.eti.meta.lock.v2.PinKeyboardType;
import org.eti.meta.logging.Log;
import org.eti.meta.megaphone.Megaphones;
import org.eti.meta.registration.service.KeyBackupSystemWrongPinException;
...
public final class PinState {
  ...
  /**
   * Should only be called by {@link org.eti.meta.migrations.RegistrationPinV2MigrationJob}.
   */
  @WorkerThread
