...
import org.eti.meta.attachments.MmsNotificationAttachment;
import org.eti.meta.contactshare.Contact;
import org.eti.meta.database.documents.IdentityKeyMismatch;
import org.eti.meta.database.documents.IdentityKeyMismatchList;
import org.eti.meta.database.documents.NetworkFailure;
import org.eti.meta.database.documents.NetworkFailureList;
...
import org.eti.meta.database.model.NotificationMmsMessageRecord;
...
import org.eti.meta.mms.MessageGroupContext;
import org.eti.meta.mms.MmsException;
import org.eti.meta.mms.OutgoingExpirationUpdateMessage;
import org.eti.meta.mms.OutgoingGroupUpdateMessage;
...
import org.eti.meta.revealable.ViewOnceExpirationInfo;
import org.eti.meta.revealable.ViewOnceUtil;
import org.eti.meta.util.JsonUtils;
...
import static org.eti.meta.contactshare.Contact.Avatar;
...
//  }
  ...
  public void markIncomingNotificationReceived(long threadId) {
    ...
    if (org.eti.meta.util.Util.isDefaultSmsProvider(context)) {
      DatabaseFactory.getThreadDatabase(context).incrementUnread(threadId, 1);
    }
  ...
  public class Reader implements Closeable {
    ...
    private NotificationMmsMessageRecord getNotificationMmsMessageRecord(Cursor cursor) {
      ...
      if (!TextUtils.isEmpty(contentLocation))
        contentLocationBytes = org.eti.meta.util.Util.toIsoBytes(contentLocation);

      if (!TextUtils.isEmpty(transactionId))
        transactionIdBytes = org.eti.meta.util.Util.toIsoBytes(transactionId);
