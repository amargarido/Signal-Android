...
import org.eti.meta.database.GroupDatabase.GroupRecord;
...
public class PushGroupUpdateJob extends BaseJob {
  ...
  public static final class Factory implements Job.Factory<PushGroupUpdateJob> {
    @Override
    public @NonNull PushGroupUpdateJob create(@NonNull Parameters parameters, @NonNull org.eti.meta.jobmanager.Data data) {
