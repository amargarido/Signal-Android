...
import org.eti.meta.blurhash.BlurHashEncoder;
...
public final class AttachmentUploadJob extends BaseJob {
  ...
  public static final class Factory implements Job.Factory<AttachmentUploadJob> {
    @Override
    public @NonNull AttachmentUploadJob create(@NonNull Parameters parameters, @NonNull org.eti.meta.jobmanager.Data data) {
