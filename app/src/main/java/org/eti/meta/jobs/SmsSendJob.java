...
import org.eti.meta.service.SmsDeliveryListener;
...
public class SmsSendJob extends SendJob {
  ...
  public static class Factory implements Job.Factory<SmsSendJob> {
    @Override
    public @NonNull SmsSendJob create(@NonNull Parameters parameters, @NonNull org.eti.meta.jobmanager.Data data) {
